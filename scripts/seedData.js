...
console.log('📖 Baca README.md untuk informasi lengkap');

// Write to a temporary file for reference
const outputPath = path.join(process.cwd(), 'seed-output.json');
fs.writeFileSync(outputPath, JSON.stringify(seedPosts, null, 2));
console.log(`📄 Seed data disimpan ke: ${outputPath}`);